...
public class FragmentMainBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.recyclerview_main, 1);
        sViewsWithIds.put(R.id.add_form, 2);
        sViewsWithIds.put(R.id.button_add, 3);
    }
    // views
    public final android.widget.LinearLayout addForm;
    public final android.widget.Button buttonAdd;
    private final android.widget.RelativeLayout mboundView0;
    public final android.support.v7.widget.RecyclerView recyclerviewMain;
    // variables
    // values
    // listeners
    ...
    public FragmentMainBinding(android.databinding.DataBindingComponent bindingComponent, View root) {
        ...
        this.addForm = (android.widget.LinearLayout) bindings[2];
        this.buttonAdd = (android.widget.Button) bindings[3];
        this.mboundView0 = (android.widget.RelativeLayout) bindings[0];
        this.mboundView0.setTag(null);
        this.recyclerviewMain = (android.support.v7.widget.RecyclerView) bindings[1];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public static FragmentMainBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<FragmentMainBinding>inflate(inflater, com.familsoft.tr4tr.translatorfortraveler.R.layout.fragment_main, root, attachToRoot, bindingComponent);
    }
    ...
    public static FragmentMainBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.familsoft.tr4tr.translatorfortraveler.R.layout.fragment_main, null, false), bindingComponent);
    }
